...
//       .then(r => setModules(r.data.results))
//       .catch(console.error)
//   }, [])
...
//     try {
//       const r = await api.post<Module>('//modules/', { title, code })
//       setModules(m => [r.data, ...m])
//     } catch (e) {
//       console.error(e)
...
//     if (!quizId) return
//     try {
//       await api.post('//modules/add_quiz/', { module_id: moduleId, quiz_id: Number(quizId) })
