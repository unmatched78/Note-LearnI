...
import { History, BookOpen, LogOut, Plus, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-4 pb-6 border-t flex flex-col">
        ...
        {profileOpen && (
          <div className="mt-2 bg-gray-100 dark:bg-gray-800 p-2 rounded shadow-inner">
            <Button variant="link" className="w-full text-left hover:underline">Profile Settings</Button>
            <Button variant="link" className="w-full text-left hover:underline" onClick={() => signOut()}>Sign Out</Button>
          </div>
        )}
      </div>
    </div>
